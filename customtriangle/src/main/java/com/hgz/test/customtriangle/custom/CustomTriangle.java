package com.hgz.test.customtriangle.custom;
...
public class CustomTriangle extends View {
    ...
    public CustomTriangle(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public CustomTriangle(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
